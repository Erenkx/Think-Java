...
public class GridCanvas extends Canvas {
    ...
    /**
     * Returns 1 if the cell at (r, c) exists and is on. Returns 0 if the
     * cell does not exist or is off.
     *
     * @param r row index
     * @param c column index
     * @return 1 or 0
    ...
    /**
     * Overriding this method helps the simulation run more smoothly.
     * Normally the Canvas is cleared before painting, but there is no
     * need to clear it since the paint method draws the entire grid.
     *
     * @param g graphics context
     */
