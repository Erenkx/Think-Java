...
public class RegularPolygon extends DrawablePolygon {
    ...
    /**
     * Constructs a regular polygon, given the number of sides and radius.
     *
     * @param nsides the number of sides
    ...
    /**
     * Constructs a regular polygon, given the number of sides, the radius,
     * and fill color.
     *
     * @param nsides the number of sides
     * @param radius from center to vertex
    ...
    public RegularPolygon(int nsides, int radius, Color color) {
        ...
        // calculate the amount to rotate for each vertex (in radians)
